...
compile: prospector genetic hillclimb hillclimb64 hp16
...
hillclimb64: hillclimb64.c
	$(CC) $(LDFLAGS) $(CFLAGS) -o $@ hillclimb64.c $(LDLIBS)
...
clean:
	rm -f prospector genetic hillclimb hillclimb64 hp16 $(hashes)
